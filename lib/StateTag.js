...
var StateTag = module.exports = function StateTag(){
...
StateTag.prototype.start = function(ctx){
	...
	if( typeof this.emptyTags[lowTagName]!="undefined" && this.emptyTags[lowTagName] )
	{
		eleTag.single = true ;
	}
...
StateTag.prototype.examineEnd = function(ctx){
	...
	if( tag.tail )
	{
		...
		if(!eleNode||!eleNode.headTag)
		{
			throw new ParseError("闭合节点标签时发生错误，尾标 %s 签前没有任何头标签。",[tag.tagName],ctx) ;
		}
